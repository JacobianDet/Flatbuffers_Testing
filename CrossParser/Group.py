...
def GroupAddAvgAge(builder, avgAge):
    builder.PrependFloat64Slot(1, avgAge, 0.0)

def AddAvgAge(builder, avgAge):
    GroupAddAvgAge(builder, avgAge)

def GroupAddAvgWeight(builder, avgWeight):
    builder.PrependFloat64Slot(2, avgWeight, 0.0)

def AddAvgWeight(builder, avgWeight):
    GroupAddAvgWeight(builder, avgWeight)

def GroupAddPersonNames(builder, personNames):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(personNames), 0)

def AddPersonNames(builder, personNames):
    GroupAddPersonNames(builder, personNames)

def GroupStartPersonNamesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartPersonNamesVector(builder, numElems: int) -> int:
    return GroupStartPersonNamesVector(builder, numElems)
